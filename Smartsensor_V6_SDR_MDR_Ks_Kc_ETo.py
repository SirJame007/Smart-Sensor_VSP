...
#ฟังก์ชั่นการแสดงผลการแจ้งเตือนเกี่ยวกับค่า Ks
        if 0.95 <= Ks <= 1.0:
            ...
            Ks_Alarm = "เครียดอ่อน–ปานกลาง ปากใบปิดเด่นชัด เตรียมรดน้ำ"
        elif 0.50 <= Ks < 0.70:
            ...
            Ks_Alarm = "วิกฤต ใกล้ถึงจุดเหี่ยวถาวร รดน้ำและบรรเทาความร้อนทันที!"
        else:
...
#หากค่าเซนเซอร์เรียลไทม์ของคุณ (0.30) สูงกว่าค่า FC (0.22) แสดงว่าดินมีความชื้นเกินไป 
#Dr ควรจะเป็นศูนย์ เพราะยังไม่มีปริมาณน้ำที่พืชใช้ไปจากความจุสูงสุดครับ
#เมื่อ Dr =0 ค่า Kจะเท่ากับ 1.0 ซึ่งหมายความว่าดินมีความชื้นเพียงพอ พืชไม่เครียด และยังไม่ต้องรดน้ำครับ